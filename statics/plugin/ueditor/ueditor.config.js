...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        UEDITOR_HOME_URL : editurl['editurl']

        //图片上传配置区  
	   ,imageUrl:editurl['imageupurl']		//上传地址
       ...
       ,imageFieldName:"upfile"             //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        , toolbars: [["source","fontfamily","fontsize","insertunorderedlist","insertorderedlist","insertimage","justifyleft","justifycenter","justifyright","justifyjustify","autotypeset","bold","underline","italic","strikethrough","forecolor","blockquote","backcolor","superscript","subscript","link","unlink","cleardoc","selectall","print","gmap","emotion","time","pagebreak","insertvideo","fullscreen"]]
...
//        }
		...
		,initialContent:'欢迎使用云购系统!'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
...
//          ]
        ...
        //fontsize
        //字号
        ,'fontsize':[8,9,10, 11, 12, 14, 16, 18, 20, 24, 36]
