...
//保存规则
	$this->db->Query("INSERT INTO `@#_egglotter_rule`(rule_name,starttime,endtime,subtime,lotterytype,lotterjb,
	ruledesc,startusing)VALUES('$rule_name','$starttime','$endtime','$subtime','$lotterytype',
	'$lotterjb','$ruledesc','$startusing')");
 ...
 //保存奖品表 
	for($i=0;$i<count($option1);$i++){	 	 
	  ...
	  VALUES('$rule_id','$option1[$i]','$subtime','$option3[$i]','$option2[$i]')"); 
	}
...
<form name="myform" action=""  method="post">
  <table width="100%" cellspacing="0">
    <tr>
		...
		<td>	 
		    <input class="input-text wid100 "  type="text" name="rule_name"  size="40" id="rule_name"/> 			 
  	...
  	<tr>
		...
		<td>
			...
			<div><br> 
				1等奖:<input class="input-text wid100 " class="option" type="text" name="option1[]"  size="40" require="true" id="opt1"/> 
				奖品中奖机率：<input class="input-text wid100 " class="option" type="text" name="option2[]"  size="40" require="true" id="opt2"/>
				<input   type="hidden" name="option3[]"   id="opt3" value="1"/>
				</div>
			</div>		
	...
	<tr>
		...
		<td><input  type="text" name="starttime" id="starttime" readonly class="input-text wid100 posttime" value="<?php echo $curtime;?>" ></td>
	...
	<tr>
		...
		<td><input type="text" name="endtime" id="endtime" readonly class="input-text wid100 posttime" value="<?php echo $curtime;?>"></td>
		<script type="text/javascript">
			date = new Date();
			Calendar.setup({
				inputField     :    "endtime",
	...
	<tr>
		...
		<td>
			<input type="radio" name="lotterytype" id="lotterytype1" value="1" class="input-text" checked>福分
	...
	<tr>
		...
		<td id="jbid2" ><input type="text" name="lotterjb" id="jf" class="input-text wid100" >(福分)</td>
	</tr>
	<tr>
		<td width="120" align="right">活动规则：</td>
		<td><textarea name="ruledesc" id="ruledesc" style="width:400px;height:100px"></textarea>(如：1等奖手机，2等奖50元，3等奖，很遗憾没中奖)</td>
	</tr>
	<tr>
		<td width="120" align="right">是否启用：</td>
		<td><input type="radio" name="startusing" id="startusing1" value="1" class="input-text" >启用
			<input type="radio" name="startusing" id="startusing2" value="2" class="input-text" checked>不启用
		</td>
	</tr>
	<tr>
