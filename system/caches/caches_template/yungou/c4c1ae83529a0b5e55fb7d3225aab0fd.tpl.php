		...
		<ul class="Pro">			
			<li>
				...
				<div class="Progress-bar" style="">
					<p title="已完成<?php echo percent($new_shop['canyurenshu'],$new_shop['zongrenshu']); ?>"><span style="width:<?php echo width($new_shop['canyurenshu'],$new_shop['zongrenshu'],188); ?>px;"></span></p>
					<ul class="Pro-bar-li">
	...
	<div class="goods_left">
		...
		<div class="new_lottery">        	
            ...
            <!------>
                ...
                <script type="text/javascript">
					$(document).ready(function(){gg_show_time_init("ulNewAwary",'<?php echo WEB_PATH; ?>');});
			    </script>  
            <!------>
		</div>                
		<div class="hot" style="">
