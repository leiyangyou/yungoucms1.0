		...
		<ul class="login_info" style="display: block;">
			...
			<li class="h_wel" id="logininfo">
				<a href="<?php echo WEB_PATH; ?>/member/home" class="gray01" >
					...
					<img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo uidcookie('img'); ?>" width="30" height="30"/>
					<?php  else: ?>
					<img src="<?php echo G_TEMPLATES_STYLE; ?>/images/prmimg.jpg" width="30" height="30"/>
					<?php endif; ?>
					<?php if(uidcookie('username')!=null): ?>
					<?php echo _strcut(uidcookie('username'),7,''); ?>
					<?php elseif (uidcookie('mobile')!=null): ?>
					<?php echo _strcut(uidcookie('mobile'),7,''); ?>
					<?php  else: ?>
					<?php echo _strcut(uidcookie('email'),7,''); ?>
					<?php endif; ?>
				</a>&nbsp;&nbsp;
