...
<div id="left">
    <ul class="left_date" id="setting">   
        ...
        <li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/empower">授权证书</a></li>
     ...
     <ul class="left_date" id="shop">   
       ...
       <li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/lists">订单列表</a></li>
		...
		<li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/lists/gaisend">未发货订单</a></li> 		
        <li class="head">促销管理</li>
        <li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_list/xianshi">限时揭晓商品</a></li>
        <li class="head">其他</li>
        <li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/go/shaidan_admin">晒单查看</a></li>
    </ul>
    ...
    <ul class="left_date" id="template">   
     ...
     <ul class="left_date" id="yunapp">     	
		...
		<li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/admin/fund/fundset">公益基金</a></li>
		<?php if(file_exists(G_SYSTEM.'modules/goodspecify/lib/'.'itocode.class.php')){	?><li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/goodspecify/goodspecify/init">指定中奖人</a></li><?php } ?>
    </ul>
...
<div id="right">
	<div class="right_top">
		...
		<a href="http://www.yungoucms.com/member.php?c=gongdan" target="_blank" class="system_button"><span>提交工单</span></a>		
