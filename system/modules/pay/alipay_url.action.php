...
class alipay_url extends SystemAction {
	...
	public function houtai(){
		require_once dirname(__FILE__).DIRECTORY_SEPARATOR."lib/alipay/alipay_notify.class.php";
		...
		$alipay_config_cacert =  dirname(__FILE__).DIRECTORY_SEPARATOR."lib/alipay/cacert.pem";	//ca证书路径地址
